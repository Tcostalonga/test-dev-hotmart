...
import kotlinx.android.synthetic.main.d_schedule.view.*
...
class DetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        layoutDialog =
            LayoutInflater.from(requireContext()).inflate(R.layout.d_schedule, null)
    }
        ...
        viewModel.statusRequestDetail.observe(viewLifecycleOwner, Observer {
            when (it) {
                ...
                Status.ERROR -> {
                    ...
                    binding.errorLytDetails.imgError.visibility = View.VISIBLE
