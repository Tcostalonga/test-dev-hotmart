...
const val EMPTY_INVALID_REQUEST: String =  "Desculpe, não há informação disponível no momento"
const val NOT_FOUND_REQUEST: String =  "Ocorreu um erro inesperado, tente novamente"
const val NOT_CONNECTED_REQUEST: String =  "Verifique sua conexão"
